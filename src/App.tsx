...
function Icon({ name, size = 22 }: { name: IconName; size?: number }) {
  ...
  if (name === 'home') return <svg {...common}><path d="M3.8 10.7 12 4l8.2 6.7v8.1a1.2 1.2 0 0 1-1.2 1.2h-4.4v-5.7H9.4V20H5a1.2 1.2 0 0 1-1.2-1.2v-8.1Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>;
